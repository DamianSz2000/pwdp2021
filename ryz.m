...
disp("Promien ziemi: 6.371009*10^6 m^3")
r = 6.371009*10^6;
...
v = x+y;
disp(v)
disp("Teraz wyznaczamy R calej objetosci ze wzoru na objetosc kuli")
R = ((3*v)/(4*pi))*(1/3);
disp(R)
disp("Teraz promien calkowity odjac promien ziemii da wysokosc warstwy ryzu:")
h = R-r;
disp(h)
